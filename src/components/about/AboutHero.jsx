...
const AboutHero = () => {
    ...
    return (
        <section className="relative min-h-[90vh] max-[426px]:min-h-[60vh] flex items-center overflow-hidden bg-[#fafafa] py-10">
            ...
            <div className="mx-auto px-4 lg:px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <motion.p variants={itemVariants} className="text-lg md:text-xl max-[426px]:text-base text-paragraph mb-12 leading-relaxed">
