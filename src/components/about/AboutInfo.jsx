                    ...
                    >
                        <div className="space-y-6">
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white border border-slate-100 shadow-sm"
                            >
                                <TrendingUp size={16} className="text-primary" />
                                <span className="text-primary text-xs font-black tracking-[0.2em] uppercase">The Legacy of Excellence</span>
                            </motion.div>

                            <h2 className="text-5xl md:text-6xl font-black text-heading leading-[1.1] tracking-tight">
                                Delivering Reliability <br />
                                <span className="text-primary italic">Since 1995.</span>
                            </h2>

                            <p className="text-paragraph text-xl leading-relaxed font-medium max-w-xl">
                        ...
                        <div className="space-y-6">
                            {coreValues.map((value, index) => (
                                <motion.div 
                                    ...
                                    viewport={{ once: true }}
                                    className="group p-8 bg-white border border-slate-100 rounded-[40px] hover:border-primary/40 hover:shadow-[0_20px_50px_rgba(255,117,24,0.08)] transition-all duration-500 cursor-pointer relative overflow-hidden"
                                >
                                    ...
                                    <div className="flex gap-8 items-start relative z-10">
                                        <div className={`p-5 rounded-[24px] ${value.bg} ${value.color} group-hover:bg-primary group-hover:text-white transition-all duration-500 transform group-hover:rotate-6`}>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <p className="text-paragraph text-lg leading-relaxed font-medium">
                                                {value.description}
                                            </p>
                                        </div>
                                    </div>
